...
THRESH_METHOD = {
    BINARY_THRESH_METHOD: cv2.THRESH_BINARY,
    BINARY_INV_THRESH_METHOD: cv2.THRESH_BINARY_INV,
    TRUNC_THRESH_METHOD: cv2.THRESH_TRUNC,
    TOZERO_THRESH_METHOD: cv2.THRESH_TOZERO,
    TOZERO_INV_THRESH_METHOD: cv2.THRESH_TOZERO_INV,
    OTSU_THRESH_METHOD: cv2.THRESH_OTSU
}
